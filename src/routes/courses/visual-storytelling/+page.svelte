<script lang="ts">
	import { visualStorytellingCourse, visualStorytellingModules } from '$lib/data/courses';
	const course = visualStorytellingCourse;
	const modules = visualStorytellingModules;
</script>
...
<div class="page-wrapper vs-theme">
	...
	<div class="course-hero">
		<div class="hero-ghost" aria-hidden="true">STORY</div>
		<div class="hero-label">Visual Storytelling for Faceless Video</div>
		<h1 class="hero-title">Communicate <span>Meaning</span>, Not Just Information</h1>
